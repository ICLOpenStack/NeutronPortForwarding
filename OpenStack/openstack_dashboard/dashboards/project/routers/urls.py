...
urlpatterns = patterns(
    ...
    url(ROUTER_URL % 'addinterface',
        ...
        name='addinterface'),
    url(ROUTER_URL % 'addportforwarding',
        portforwarding_views.AddPortForwardingView.as_view(),
        name='addportforwarding'),
    url(r'^(?P<router_id>[^/]+)/(?P<id>[^/]+)/editportforwarding',
        portforwarding_views.EditPortForwardingView.as_view(),
        name='editportforwarding'),
