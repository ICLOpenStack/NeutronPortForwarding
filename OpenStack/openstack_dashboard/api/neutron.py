...
class RouterPortForwarding(NeutronAPIDictWrapper):
    """Wrapper for neutron router port forwardings."""

    def __init__(self, apiresource):
        apiresource['id'] = '%s_%s_%s_%s' % (apiresource['protocol'],apiresource['outside_port'],
                                             apiresource['inside_addr'],apiresource['inside_port'],)
        super(RouterPortForwarding, self).__init__(apiresource)
